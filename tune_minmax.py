...
# --- CONFIG ---
INPUT_MODEL = "yolov8n_final_pruned.onnx"   # The Pruned + Healed Float32 model
OUTPUT_MODEL = "yolov8n_final_int8_minmax.onnx"

def find_dataset():
    # Use the same COCO128 images
...
def run_tuning():
    print(f"🚀 Quantizing with MinMax: {INPUT_MODEL} ...")
    ...
    quantize_static(
        ...
        # --- THE FIX ---
        # MinMax preserves the full range, critical for bounding box coordinates
    ...
    print(f"🎉 DONE! MinMax Model: {OUTPUT_MODEL}")
